import os
path = r"D:\JORGE CHARME E LEON\SISTEMAS\N8N AUTOMACOES\hermes_agents\core\vendas.py"
content = '''"""Vendas Core — Pedidos, Itens, Pagamentos, Dashboard, Integracao Bling"""
...
with open(path, "w", encoding="utf-8", newline="\n") as f:
    f.write(content)
print(f"Vendas Core: {len(content)} bytes")
