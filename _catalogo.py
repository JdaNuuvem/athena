import os
path = r"D:\JORGE CHARME E LEON\SISTEMAS\N8N AUTOMACOES\hermes_agents\core\catalogo.py"
content = '''"""Catalogo SSOT — Fonte unica de verdade para Produtos. Todas as tabelas referenciam este catalogo."""
...
with open(path, "w", encoding="utf-8", newline="\n") as f:
    f.write(content)
print(f"Catalogo SSOT: {len(content)} bytes")
