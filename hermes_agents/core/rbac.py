...
def _ensure_tables():
    async def _go():
        ...
        for codigo_permissao in ("estoque.aprovar", "pdv.aprovar", "compras.excluir", "rh.ver", "rh.criar", "rh.editar", "cadastros.excluir", "vendas.excluir", "crm.excluir", "atendimento.excluir", "producao.ver", "producao.criar", "producao.editar"):
            try:
