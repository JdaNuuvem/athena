import os
path = r"D:\JORGE CHARME E LEON\SISTEMAS\N8N AUTOMACOES\hermes_agents\core\entidades.py"
content = '''"""Entidades SSOT — Unificacao Clientes, Fornecedores, Vendedores, Lojas + Eventos cross-module"""
...
with open(path, "w", encoding="utf-8", newline="\n") as f:
    f.write(content)
print(f"Entidades SSOT: {len(content)} bytes")
