...
export default function Page() {
  ...
  useEffect(() => {
    let url = apis["vendas"] || "/api/relatorios/vendas";
    if (["vendas","lucro","ticket-medio","dre","fluxo-caixa","clientes","previsao"].includes("vendas")) url += "?dias="+dias;
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between"><div><h1 className="text-lg font-bold text-neutral-100">Vendas</h1><p className="text-xs text-neutral-500 mt-1">Total, quantidade e vendas diarias</p></div>
        {["vendas","lucro","ticket-medio","dre","fluxo-caixa","clientes","previsao"].includes("vendas") && (
