...
export default function Page() {
  ...
  useEffect(() => {
    let url = apis["ticket-medio"] || "/api/relatorios/ticket-medio";
    if (["vendas","lucro","ticket-medio","dre","fluxo-caixa","clientes","previsao"].includes("ticket-medio")) url += "?dias="+dias;
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between"><div><h1 className="text-lg font-bold text-neutral-100">Ticket Medio</h1><p className="text-xs text-neutral-500 mt-1">Valor medio por venda</p></div>
        {["vendas","lucro","ticket-medio","dre","fluxo-caixa","clientes","previsao"].includes("ticket-medio") && (
