...
const SEVERIDADE_STYLE: Record<string, { dot: string; bg: string; text: string; label: string }> = {
  critico: { dot: "bg-red-500", bg: "bg-red-500/10", text: "text-red-400", label: "Crítico" },
  moderado: { dot: "bg-amber-500", bg: "bg-amber-500/10", text: "text-amber-400", label: "Moderado" },
  baixo: { dot: "bg-blue-500", bg: "bg-blue-500/10", text: "text-blue-400", label: "Baixo" },
};
  ...
  return (
    <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4 space-y-2">
      <div className="flex items-center justify-between">
        <span className={`inline-flex items-center gap-1.5 text-[10px] uppercase px-2 py-0.5 rounded ${s.bg} ${s.text} border border-current/30`}>
