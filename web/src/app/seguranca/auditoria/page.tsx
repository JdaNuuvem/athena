...
export default function Page() {
  ...
  const apiUrl = "/api/auditoria";

  useEffect(() => {
    fetch(apiUrl).then(r=>r.json()).then(d => {
      setItems(d.auditoria || []);
  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between"><div><h1 className="text-lg font-bold text-neutral-100">Auditoria</h1><p className="text-xs text-neutral-500 mt-1">Registro de todas as acoes do sistema</p></div></div>
