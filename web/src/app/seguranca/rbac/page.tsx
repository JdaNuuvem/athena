...
export default function Page() {
  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between"><div><h1 className="text-lg font-bold text-neutral-100">RBAC</h1><p className="text-xs text-neutral-500 mt-1">Gerenciar papeis e permissoes</p></div></div>
