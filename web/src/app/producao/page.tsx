...
const MODULOS = [
  ...
  { href: "/producao/custos", label: "Custos", color: "bg-indigo-600", help: "Custos de producao por OP" },
];
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4" title="Pecas boas / total * 100"><p className="text-xs text-neutral-500">Rendimento <HelpTooltip text="Percentual de pecas boas sobre o total produzido" /></p><p className="text-xl font-bold text-emerald-400">{dash?.rendimento_pct??0}%</p></div>
      </div>
