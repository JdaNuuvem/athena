...
4. **Script de bootstrap** (`scripts/`, versionado) — configura via Rocket.Chat Admin REST API o "Custom OAuth" apontando para os 3 endpoints acima, com o mapeamento de campos. Evita depender de configuração manual pela UI admin (perdível/não versionada).
